...
using namespace mpu;
MPU9250::MPU9250(mpu_bus_t *bus) : MPU(bus)
{
}
...
mpu_err_t MPU9250::setGyroFullScaleSelect(GYRO_FS gyro_fs_sel)
{
...
mpu_err_t MPU9250::setAccelFullScaleSelect(ACCEL_FS accel_fs_sel)
{
...
mpu_err_t MPU9250::measureGyro(float result[3])
{
...
mpu_err_t MPU9250::measureAccel(float result[3])
{
